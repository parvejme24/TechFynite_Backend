...
router.post('/blogs', auth_1.authMiddleware, upload_1.uploadBlogFiles, blog_controller_1.createBlog);
router.put('/blogs/:id', auth_1.authMiddleware, upload_1.uploadBlogFiles, blog_controller_1.updateBlog);

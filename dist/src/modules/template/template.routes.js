...
router.post('/templates', auth_1.authMiddleware, auth_1.adminOrSuperAdminOnly, cloudinary_upload_1.uploadTemplateFilesCloudinary, template_controller_1.createTemplate);
router.put('/templates/:id', auth_1.authMiddleware, auth_1.adminOrSuperAdminOnly, cloudinary_upload_1.uploadTemplateFilesCloudinary, template_controller_1.updateTemplate);

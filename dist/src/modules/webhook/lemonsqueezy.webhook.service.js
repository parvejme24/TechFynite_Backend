...
exports.LemonSqueezyWebhookService = void 0;
const database_1 = require("../../config/database");
const crypto_1 = __importDefault(require("crypto"));
const LEMONSQUEEZY_WEBHOOK_SECRET = process.env.LEMONSQUEEZY_WEBHOOK_SECRET;
exports.LemonSqueezyWebhookService = {
    ...
    processWebhook: async (body) => {
        ...
        const orderInvoice = await database_1.prisma.orderInvoice.create({
            data: {
        ...
        if (status === 'paid') {
            ...
            const licenseKey = await exports.LemonSqueezyWebhookService.getLicenseFromLemonSqueezy(orderId);
            if (licenseKey) {
    ...
    getLicenseFromLemonSqueezy: async (orderId) => {
        try {
